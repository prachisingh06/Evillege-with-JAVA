...
public class Registrationcode extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        {
           String command="insert into registration values('"+name+"','"+Fathername+"','"+gender+"','"+quali+"','"+mob+"','"+add+"','"+email+"','"+email+fileName+"','"+city+"','"+d.toString()+"')";
           PrintWriter out=response.getWriter();
           if(cm.ExecuteInsertUpdateOrDelete(command))
           {
            out.print("<script>alert('Your Registration Completed Successfully');window.location.href='/Evillage2/registration1.html'</script>");
           }
           else
           {
            out.print("<script>alert('Your Registration is Not completed');window.location.href='/Evillage2/registration1.html'</script>");
           }
        ...
        {
            PrintWriter out=response.getWriter();
           out.print("<script>alert('Invalid Captcha code');window.location.href='/Evillage2/registration1.html'</script>");
        }
