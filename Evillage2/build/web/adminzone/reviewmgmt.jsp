...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p style="color:teal;font-size:38px; text-align: center; text-shadow: 2px 3px 4px black;"><b><u>WELCOME TO REVIEW MANAGEMENT</u></b></h1>
<div class="row" style="background:background-size:100% 100%;min-height: 300px;">
                <div class="col-sm-3"></div>
                <div class="col-sm-6">
                 <table border="5" width="100%" style="margin-top:30px;background:linear-gradient(teal,azure,white,azure);border:4px solid black;box-shadow: 2px 3px 5px 6px black">
                ...
                <%
                  ...
                  {
                   %>
              <tr style=" color:black;font-size:18px; text-align: center;">
                  <td><%=rs.getString(1)%></td>
                  <td><%=rs.getString(2)%></td>
                  <td><%=rs.getString(3)%></td>
                  <td><a href="../code/deleterev.jsp?d=<%=rs.getString(1)%>">
