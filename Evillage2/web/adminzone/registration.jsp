 ...
 <%
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h1 style="font-size:38px; color:teal;text-align: center;text-shadow: 2px 3px 4px black;"><b><u>WELCOME TO REGISTRATION MANAGEMENT</u></b></h1>
<div class="row" style="background-size:100% 100%;">
                <div class="col-sm-12">
                 <table border="5" width="100%" style="background:linear-gradient(teal,azure,white,azure);border:3px solid black; margin-top:30px;box-shadow:2px 4px 4px 5px black;">
              ...
              <tr style=";font-size:18px; text-align: center;">
                  ...
                  <td><a href="../code/deleteregis.jsp?d=<%=rs.getString(7)%>">
